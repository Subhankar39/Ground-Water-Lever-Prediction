...
try:
    with open(r"C:\Users\lenovo\Desktop\NEW1\groundwater_model.pkl", 'rb') as file:
...
try:
    with open(r"C:\Users\lenovo\Desktop\NEW1\scaler.pkl", 'rb') as file:
...
try:
    data = pd.read_csv(r"C:\Users\lenovo\Desktop\NEW1\cleaned_file.csv")
